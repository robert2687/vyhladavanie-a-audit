        ...
        <div className="flex items-center gap-2 sm:gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-[10px] sm:text-[11px] font-semibold bg-stone-100 text-stone-600 px-1.5 sm:px-2 py-0.5 rounded-full">
                {history.length}
              </span>
            </div>
        ...
        <div className="mt-3 flex flex-wrap gap-2 sm:gap-2.5">
          {history.map((item) => (
            ...
            >
              ...
              <div className="hidden group-hover:flex absolute right-8 top-1/2 -translate-y-1/2 items-center gap-1 text-[10px] font-bold text-blue-600 bg-white/95 px-1.5 py-0.5 rounded shadow-2xs border border-blue-200">
