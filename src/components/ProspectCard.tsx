...
- Body: ${prospect.coldOutreach.body}`;
  ...
  return (
    <div className="bg-white rounded-2xl border border-stone-200/90 shadow-sm overflow-hidden hover:shadow-md transition-shadow">
      {/* Top Bar / Header */}
      <div className="p-4 sm:p-6 bg-gradient-to-r from-stone-50 via-white to-stone-50 border-b border-stone-100 flex flex-col sm:flex-row sm:items-start justify-between gap-3.5 sm:gap-4">
        <div className="space-y-1">
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
            ...
            {prospect.ico && (
              <span className="font-mono text-[11px] sm:text-xs font-semibold px-2 py-0.5 rounded-md bg-stone-100 text-stone-700 border border-stone-200">
                IČO: {prospect.ico}
              </span>
            )}
            <span className="text-[11px] sm:text-xs font-medium px-2 py-0.5 rounded-md bg-blue-50 text-blue-800 border border-blue-200">
              {prospect.industry}
            </span>
          </div>

          <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs text-stone-600 pt-0.5">
          ...
          >
            {isSaved ? (
              <>
                ...
                <span className="truncate">V Pipeline</span>
              </>
            ) : (
              <>
                <Bookmark className="w-4 h-4 text-stone-400 shrink-0" />
                <span className="truncate">Uložiť do Pipeline</span>
              </>
            )}
          </button>
          ...
          >
            {copiedSchema ? (
              ...
              <>
                ...
                <span className="truncate">Kopírovať schému</span>
              </>
            )}
          </button>
        </div>
      ...
      <div className="p-4 sm:p-6 space-y-5 sm:space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4 p-3.5 sm:p-4 rounded-xl bg-stone-50/80 border border-stone-200/70">
          {/* Website */}
          <div>
        ...
        <div className="border-t border-stone-100 pt-4 sm:pt-5">
          ...
          <div className="p-3.5 rounded-xl bg-blue-50/60 border border-blue-100 text-xs sm:text-sm text-stone-800 font-medium leading-relaxed">
            {prospect.valueProposition}
          </div>
        </div>
        ...
        <div className="border-t border-stone-100 pt-4 sm:pt-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 mb-3">
            ...
            <div className="grid grid-cols-3 sm:flex items-center gap-1.5 sm:gap-2">
              ...
              >
                ...
                <span className="truncate">Upraviť</span>
              </button>
              ...
              >
                {copiedEmail ? (
                  ...
                  <>
                    ...
                    <span className="truncate">Kopírovať</span>
                  </>
                )}
              </button>
          ...
          {/* Email Preview Box */}
          <div className="rounded-xl border border-stone-200 bg-stone-50/50 p-3.5 sm:p-4 space-y-2.5 sm:space-y-3 font-sans text-xs sm:text-sm">
            <div>
        ...
        <div className="border-t border-stone-100 pt-3.5 sm:pt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 text-xs">
          ...
          <div className="grid grid-cols-3 sm:flex items-center gap-1.5 sm:gap-2">
            ...
            >
              <span className="truncate">ORSR výpis</span>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-1 px-2 sm:px-2.5 py-2 sm:py-1 rounded-lg bg-stone-100 hover:bg-stone-200 text-stone-800 font-semibold transition-colors min-h-[38px] touch-manipulation text-center"
            >
              <span className="truncate">FinStat profil</span>
              <ExternalLink className="w-3 h-3 text-stone-400 shrink-0" />
            </a>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-1 px-2 sm:px-2.5 py-2 sm:py-1 rounded-lg bg-stone-100 hover:bg-stone-200 text-stone-800 font-semibold transition-colors min-h-[38px] touch-manipulation text-center"
            >
              <span className="truncate">Overit.sk</span>
              <ExternalLink className="w-3 h-3 text-stone-400 shrink-0" />
            </a>
          </div>
        </div>
